...
export default () => {
    ...
    const topEdge = bottomActions?.y - height + bottomActions?.height + insets.top; // offset of the sticky footer 
        ...
        >
            ...
            {bottomActions && <Animated.View style={[styles.bottomActions, {
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Animated.View style={[styles.icon, { transform: [{ translateX: scrollY.interpolate({ inputRange, outputRange: [60, 60, 60, 0, 0] }) }] }]}>
